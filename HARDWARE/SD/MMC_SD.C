...
*/
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8;				 //PB12 推挽 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 	GPIO_Init(GPIOD, &GPIO_InitStructure);
 	GPIO_SetBits(GPIOD,GPIO_Pin_8);						 //PB12上拉
...
u8 SD_Init(void)
{
	...
	SDCardInfo.CardCapacity = SD_GetSectorCount();
	SDCardInfo.CardBlockSize = 4096;
